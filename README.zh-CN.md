...
<p align="center"><sub>适配 Windows 深浅色与显示器 DPI。</sub></p>
...
| ⏱️ | **空闲动作** | 真实键盘、鼠标持续无操作后，自动锁定、睡眠、休眠、关机或重启。 |
